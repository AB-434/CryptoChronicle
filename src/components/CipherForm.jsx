...
export const CipherForm = () => {
  ...
  return (
    <div className="min-h-screen bg-[#333446] from-slate-50 to-blue-50 p-4">
      <div className="max-w-7xl mx-auto h-[700px] flex flex-col mt-16">

        {/* Header */}
        <div className="text-center py-6">
          <h1 className="text-3xl font-bold text-[#B8CFCE] mb-1">CryptoChronicle</h1>
          <p className="text-[#B8CFCE] text-sm">Classical Encryption and Decryption Algorithms</p>
        </div>
        ...
        {/* Footer */}
        <div className="text-center py-4 text-[#B8CFCE] text-xs">
